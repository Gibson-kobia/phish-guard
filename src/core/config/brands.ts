import { ProtectedBrand } from '../types';

export const DEFAULT_PROTECTED_BRANDS: ProtectedBrand[] = [
  {
    id: 'vinted',
    name: 'Vinted',
    canonicalDomains: [
...
export const DEMO_KNOWN_MALICIOUS_DOMAINS: string[] = [
...
export const KNOWN_URL_SHORTENERS: string[] = [
  'bit.ly', 'tinyurl.com', 't.co', 'goo.gl', 'is.gd', 'buff.ly',
  'ow.ly', 'cutt.ly', 'rebrand.ly', 'shorte.st', 'tiny.cc', 'bc.vc'
];
