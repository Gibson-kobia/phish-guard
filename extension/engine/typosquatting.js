import { HOMOGLYPH_MAP } from '../config/rules.js';
import { DEFAULT_PROTECTED_BRANDS } from '../config/brands.js';
function normalizeVisualSubstitutions(text) {
  let normalized = "";
  let i = 0;
  while (i < text.length) {
    if (i + 1 < text.length) {
